...
const Login = ({ onAuth, onBack, onSwitch, onForgot }) => {
  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      ...
      <button type="submit" disabled={loading} className="w-full bg-zinc-900 text-white py-4 rounded-2xl font-black shadow-xl dark:bg-zinc-700 disabled:opacity-60 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2">{loading && <ButtonSpinner />} {loading ? 'Connexion…' : 'Se connecter'}</button>
